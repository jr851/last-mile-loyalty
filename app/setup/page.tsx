    ...
    <div className="min-h-screen bg-amber-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-amber-700 mt-1">Just two quick steps</p>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 mb-6">
          <div
            className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${
              step >= 1 ? "bg-amber-500 text-white" : "bg-amber-100 text-amber-400"
            }`}
          >
            1
          </div>
          <div className={`h-0.5 w-12 ${step >= 2 ? "bg-amber-400" : "bg-amber-200"}`} />
          <div
            className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${
              step >= 2 ? "bg-amber-500 text-white" : "bg-amber-100 text-amber-400"
            }`}
          >
            2
          </div>
          ...
          {step === 1 && (
            <div className="space-y-5">
              <div>
                ...
                <p className="text-sm text-gray-500">Tell us about your café or shop</p>
              </div>
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <div className="text-white/80 text-xs">
                  Collect {stampsNeeded} stamps → {rewardDescription}
                </div>
              </div>
